...
var sources = []*ast.Source{
	{Name: "../schema/address.graphql", Input: `type Address {
  id: Int!
  street: String!
  country: String!
}
...
func (ec *executionContext) _User_address(ctx context.Context, field graphql.CollectedField, obj *model.User) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOAddress2ᚖtestᚋgraphᚋmodelᚐAddress(ctx, field.Selections, res)
}
...
func (ec *executionContext) _User_todo(ctx context.Context, field graphql.CollectedField, obj *model.User) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Todo)
	fc.Result = res
	return ec.marshalOTodo2ᚖtestᚋgraphᚋmodelᚐTodo(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOAddress2ᚖtestᚋgraphᚋmodelᚐAddress(ctx context.Context, sel ast.SelectionSet, v *model.Address) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
...
func (ec *executionContext) marshalOTodo2ᚖtestᚋgraphᚋmodelᚐTodo(ctx context.Context, sel ast.SelectionSet, v *model.Todo) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Todo(ctx, sel, v)
